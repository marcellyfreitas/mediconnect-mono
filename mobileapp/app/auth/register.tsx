			...
			<ScrollView contentContainerStyle={{ flexGrow: 1 }}>
				<ThemedView className="items-center justify-center flex-1 p-8 bg-gray-500">
					<View className="flex flex-col w-full gap-5">
						...
						<View>
							<ThemedText>Ao clicar em finalizar você está concordando com os nossos
								<TouchableOpacity className="font-semibold text-primary-500" onPress={() => router.push('/auth/termos')}> Termos de Uso e Políticas de Privacidade</TouchableOpacity></ThemedText>
						</View>
						...
						<View className="flex flex-col w-full gap-4">
							...
							<Button
								...
								disabled={loading}
							>
								<Text className="font-bold text-secondary-500">Finalizar</Text>
							</Button>
							...
							<View className="flex flex-row items-center justify-center w-full gap-2 text-center">
								...
								>
									...
									<Text className="font-semibold text-primary-500">Fazer login</Text>
								</TouchableOpacity>
							</View>
						</View>
					</View>
