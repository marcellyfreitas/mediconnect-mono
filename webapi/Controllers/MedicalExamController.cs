...
public class MedicalExamController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<IEnumerable<MedicalExam>>> GetAllAsync(string search)
    {
        ...
        {
    var allViewModels = list.Select(m => new MedicalExam
    {
        Id = m.Id,
    ...
    return StatusCode(200, ApiHelper.Ok(allViewModels));        
}
        var viewModels = list
            .Where(m =>
